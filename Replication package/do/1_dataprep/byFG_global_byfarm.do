...
keep country hhid HDDS_? HDDS_?? HDDS_?_own HDDS_??_own HDDS_?_purch HDDS_??_purch HDDS_?_rec HDDS_??_rec *_purchindep *_purch_only occup_agr_any wgt stratum psu totpop surveyid w_new

gen insample = (HDDS_1 < . & occup_agr_any < .) 
...
mat colnames M = _Foodgroup occup_agr_any

* Consumption (sample: 1069031)
svy, subpop(insample): mean HDDS_? HDDS_?? , over(occup_agr_any)
...
* Purchases
svy, subpop(insample): mean HDDS_?_purch HDDS_??_purch, over(occup_agr_any)
...
* Own consumption
svy, subpop(insample): mean HDDS_?_own HDDS_??_own, over(occup_agr_any)
...
* Gifts/in-kind (sample: 735713)
svy, subpop(insample): mean HDDS_?_rec HDDS_??_rec, over(occup_agr_any)
...
* Only Purchases
svy, subpop(insample): mean HDDS_?_purch_only HDDS_??_purch_only, over(occup_agr_any)
...
* Label variables
lab var occup_agr_any "Agricultural household"
...
save "$datadir/graphs and tables/FG_global_byfarm.dta", replace
